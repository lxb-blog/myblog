...
| :--------- | :------------------------------------------------------------------------ |
| 站点名称   | 李小白`Blog                                                               |
| 站点截图   | https://image.thum.io/get/width/400/crop/800/allowJPG/wait/20/anheyu.com/https://blog.lxb.icu |
| 站点链接   | https://blog.lxb.icu/                                                        |
| 站长头像   | https://q1.qlogo.cn/g?b=qq&nk=648226460&s=640       |
| 站点描述   | 与风共舞，随心而行                                                        |
| 站点关键词 | 李小白, 个人博客， 生活                                                   |
...
- {
    ...
    intro: "与风共舞，随心而行",
    link: "https://blog.lxb.icu/",
    image: "https://q1.qlogo.cn/g?b=qq&nk=648226460&s=640",
  }
```
...
```yml
{
  "title": "李小白",
  "avatar": "https://q1.qlogo.cn/g?b=qq&nk=648226460&s=640",
  "screenshot": "https://image.thum.io/get/width/400/crop/800/allowJPG/wait/20/anheyu.com/https://blog.lxb.icu",
  "url": "https://blog.lxb.icu/",
  "description": "与风共舞，随心而行",
  "group": ,#根据你的博客来定义
}
...
```html
<a href="https://blog.lxb.icu/" rel="external nofollow">李小白</a>
```
...
```code
a(href='https://blog.lxb.icu/' rel="external nofollow") 李小白
```
...
1. 我的名称: `李小白`
2. 网站地址: `https://blog.lxb.icu/`
3. 描述: `与风共舞，随心而行`
4. 头像: `https://q1.qlogo.cn/g?b=qq&nk=648226460&s=640`
5. 站点截图: `https://image.thum.io/get/width/400/crop/800/allowJPG/wait/20/anheyu.com/https://blog.lxb.icu`
...
```yml
昵称：李小白
网站地址：https://blog.lxb.icu/
头像图片url：https://q1.qlogo.cn/g?b=qq&nk=648226460&s=640
描述：与风共舞，随心而行
站点截图:(可选)：https://image.thum.io/get/width/400/crop/800/allowJPG/wait/20/anheyu.com/https://blog.lxb.icu
```
...
<div id="friendlink_checkboxs" style="padding: 0px 0px 0px 1.6rem;">
  <p>
    <label class="checkbox"><input type="checkbox" id="checkbox1" onclick="checkForm()">我已添加 <b>李小白</b> 博客的友情链接</label>
  </p>
  <p>
